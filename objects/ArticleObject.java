...
public class ArticleObject extends CategoryObject{
	...
	public String getArticle_author_permission() {
	...
	public void setArticle_author_permission(String article_author_permission) {
	...
	public String toString() {
		return "ID: "+this.article_id+"\t\tCategory: "+this.article_category_id+ 
				"\tSection: "+this.article_section_id+"\tVisited: "+this.article_visited+"\tTitle: "+this.article_title;
	}
}
